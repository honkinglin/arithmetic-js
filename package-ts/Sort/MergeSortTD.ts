 ...
 * 
 */
export default function MergeSortTD(list: number[]): Array<number> {
...
function _mergeSort(list: number[], l: number, r: number): void {
    // if (l >= r) return;
...
// 归并数组
export function _merge(list: number[], l: number, mid: number, r: number): void {
    const aux: number[] = [];
